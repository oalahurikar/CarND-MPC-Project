...
//set the number of timesteps to 15
...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars) {
        ...
        // It minimize our cross track, heading, and velocity errors.
        // The part of the cost based on the reference state.
        for (int i = 0; i < N; i++) {
        ...
        // constrain erratic control inputs. if we're making a turn, we'd like the turn to be smooth, not sharp.
